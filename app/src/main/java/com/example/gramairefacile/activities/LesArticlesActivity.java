...
public class LesArticlesActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        lesArticles.add(new LesArticles(R.drawable.ic_icon_lesarticles, "LES ARTICLES DÉFINIS"));
        lesArticles.add(new LesArticles(R.drawable.ic_icon_lesarticles, "LES ARTICLES INDÉFINIS"));
        lesArticles.add(new LesArticles(R.drawable.ic_icon_lesarticles, "LES ARTICLES PARTITIFS"));
